...
class CircleProgressBar @JvmOverloads constructor(
    ...
    companion object {
        ...
        private val DEFAULT_RING_WIDTH = SizeUtils.dp2px(5f).toFloat()
        ...
        private val DEFAULT_DESC_TEXT_SIZE = SizeUtils.sp2px(12f).toFloat()
        private val DEFAULT_DESC_TEXT_COLOR = Color.parseColor("#0888FF")
        private val DEFAULT_PERCENT_TEXT_SIZE = SizeUtils.sp2px(20f).toFloat()
...
//        绘制描述文本
        ...
        val dy: Int = (fontMetricsInt.bottom - fontMetricsInt.top) / 2 - fontMetricsInt.bottom
        //绘制进度文本
        canvas.drawText(
